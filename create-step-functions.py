...
region = 'ap-southeast-2' # boto3.Session().region_name
...
job_name = 'glue-customer-churn-etl-wx'
function_name = 'arn:aws:lambda:ap-southeast-2:' + account_id + ':function:query-training-status-wx'
workflow_name = 'MyInferenceRoutine_wx'
...
registry_function_name = "ModelRegistryUpdater-wx"
...
arn_function_name = "arn:aws:lambda:ap-southeast-2:" + account_id  + ":function:" + registry_function_name
